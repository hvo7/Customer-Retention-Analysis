...
To sustain long-term profitability and growth, Simple Prod Co recognizes that long-term growth depends heavily on customer retention and repeat customers rather than customer acquisition. Thus, understanding how and why customers retain, churn, and re-engage is critical to sustaining efficient growth.

An in-depth analysis was conducted using transactional data from 2010-2011 to:
* Evaluate Customer retention behavior
* Identify which customers are most likely to churn
* Understand how retention varies across cohorts
* Segment customers and determine which groups are most valuable
